...
export function LandingCyber() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="relative bg-card border border-border rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="font-semibold">Matched Games (4)</h3>
      ...
      {/* Stats Section */}
      <section className="relative z-10 px-6 py-20 lg:px-12 border-y border-border">
        <div className="max-w-7xl mx-auto">
      ...
      <section className="relative z-10 px-6 py-20 lg:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of gamers who use PlayMate to discover what to play with friends.
          </p>
